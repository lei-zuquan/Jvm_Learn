 ...
 * @Description:
 */
public class C13_PrimMSTTest {
    public static void main(String[] args) throws Exception {
        // 准备一别加权无向图
        BufferedReader br = new BufferedReader(
                new InputStreamReader(
                        C13_PrimMSTTest.class.getClassLoader().getResourceAsStream("min_create_tree_test.txt")));
        ...
        C13_PrimMST primMST = new C13_PrimMST(G);

        // 获取最小生成树
        C10_Queue<C11_Edge> edges = primMST.edges();
