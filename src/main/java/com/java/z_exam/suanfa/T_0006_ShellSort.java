...
public class T_0006_ShellSort {
    ...
    public static void compareRunTime(){
        for (int times = 0; times < 10; times++) {
            ...
            System.out.println("Arrays.sort(arr):" + (after - before));

            before = System.currentTimeMillis();
            T_0006_ShellSort.sort(arr2);
            after = System.currentTimeMillis();
            System.out.println("T_0006_ShellSort.sort(arr2):" + (after - before));

            before = System.currentTimeMillis();
            T_0006_ShellSort.shellSort(arr2);
            after = System.currentTimeMillis();
            System.out.println("T_0006_ShellSort.shellSort(arr2):" + (after - before));
        }
    }
